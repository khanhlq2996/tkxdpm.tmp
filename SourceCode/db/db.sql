...
CREATE TABLE `copybooks` (
  `id_copy` int(6) NOT NULL,
  `id_book` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `id_librarian` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `amount` int(11) NOT NULL,
  `created` date NOT NULL,
  `status` bit(1) NOT NULL,
  PRIMARY KEY (`id_book`,`id_librarian`,`id_copy`) USING BTREE,
  KEY `copybooks_ibfk_2` (`id_librarian`),
...
CREATE TABLE `lendbooks` (
  ...
  PRIMARY KEY (`id_card`),
  KEY `id_book` (`id_book`),
  KEY `lendbooks_ibfk_2` (`id_reader`),
  KEY `lendbooks_ibfk_3` (`id_librarian`),
